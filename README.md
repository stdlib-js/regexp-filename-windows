...
```javascript
import reFilenameWindows from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-filename-windows@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { REGEXP } from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-filename-windows@v0.2.2-esm/index.mjs';
```
